...
for line in data:
    ...
    if lindata[0]=="FECHA":
        ...
        newlin=lindata[0][0:2]+'/'+lindata[0][2:4]+'/'+lindata[0][4:8]+','+lindata[1]+','+lindata[2]+','+lindata[3]+','+lindata[4]+','+lindata[5]+','+str(HH)+':'+str(MM)+','+lindata[7]+','+lindata[8]+','+lindata[9]+','+lindata[10]+','+lindata[11]+','+lindata[12]+','+lindata[13]+','+lindata[14]+','+lindata[15]+','+lindata[16]+','+lindata[17]+',\n'
        print (newlin)
        print(".")
        print("")
